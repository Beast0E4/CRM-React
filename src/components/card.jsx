...
function Card({ children, fontColor = "text-black", dividerColor = "bg-black", borderColor = "border-blue-500", backgorund = "bg-blue-300", status = 50, titleText = "Card", quantity = 50 }) {
    ...
    return (
        <div onClick={onCardCLick} className={`hover:scale-105 hover:transition-all ease-in-out duration-300 hover:cursor-pointer border-b-8 ${borderColor} w-64 h-44 rounded-md ${backgorund} flex flex-col justify-center items-center py-2`}>
